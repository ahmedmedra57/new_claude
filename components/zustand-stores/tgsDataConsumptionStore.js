...
const useTgsDataConsumptionStore = createStore('tgsDataConsumption', (set) => ({
  tgsDataConsumptionSwitch: {},
  tgsDataConsumptionSwitchSpecificLocation: {},

  selectIndividualMachine: (location, machine) => set((state) => {
    state.tgsDataConsumptionSwitch[location][machine].isSelected = true;
  }),

  selectSpecificLocationMachine: (location, specificLocation, machine) => set((state) => {
    state.tgsDataConsumptionSwitchSpecificLocation[location].subLocations[
      specificLocation
    ].devices[machine].isSelected = true;
  }),

  unselectIndividualMachine: (location, machine) => set((state) => {
    state.tgsDataConsumptionSwitch[location][machine].isSelected = false;
  }),

  unselectSpecificLocationMachine: (location, specificLocation, machine) => set((state) => {
    state.tgsDataConsumptionSwitch[location][specificLocation][machine] = false;
  }),

  setTgsDataConsumptionLocation: (data) => set((state) => {
...
export default useTgsDataConsumptionStore;
