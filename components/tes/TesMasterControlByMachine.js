  ...
  return (
    <>
      {isMobile ? (
        ...
        <Wrapper isExpanded={openMachineController}>
          {/* full screen */}
          <SectionHeader>
    ...
    cursor: EBP_mode === 0 ? 'not-allowed' : 'auto',
                ...
                >
                  <InstantHeatInner
                    ...
                    isOff={isOff || isDisabled ||  (EBP_mode === 0 && isEbp)}
                    style={{
    pointerEvents: EBP_mode === 0 ? 'none' : 'auto',
    cursor: EBP_mode === 0 ? 'not-allowed' : 'auto',
           }}
                  >
                    <Button
    ...
    cursor: EBP_mode === 0 ? 'not-allowed' : 'auto',
                    ...
                    <ControllerTitle isOff={isOff || isDisabled ||  (EBP_mode === 0 && isEbp)}>
                      instant <br></br> heat
                    </ControllerTitle>
    ...
    cursor: EBP_mode === 0 ? 'not-allowed' : 'auto',
                ...
                <SnowSensorWrapper isOff={isOff || isDisabled}>
                  <SnowSensorInner
    ...
    cursor: EBP_mode === 0 ? 'not-allowed' : 'auto',
                    ...
                    <ControllerTitle isOff={isOff || isDisabled}>
                      snow <br></br> sensor
                    </ControllerTitle>
                  </SnowSensorInner>
                </SnowSensorWrapper>
...
export default TesMasterControlByMachine;
