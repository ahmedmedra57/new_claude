...
const SystemMain = lazy(() => import('./components/commonComponentsMC/SystemMain'));
                ...
                <EssTgsTesProvider>
                  <Suspense fallback={<MainLoadingPage />}>
                    <Routes>
                      ...
                      <Route path='ess' element={<SystemMain systemType="ess" />} />
                      <Route path='tgs' element={<SystemMain systemType="tgs" />} />
                      <Route path='tes' element={<SystemMain systemType="tes" />} />
