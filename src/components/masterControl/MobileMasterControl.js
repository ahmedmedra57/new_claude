...
import SystemMain from '../commonComponentsMC/SystemMain';
...
const MobileMasterControl = () => {
  ...
  return (
    <Wrapper>
      ...
      {selectedSwt === 'ess' && <SystemMain systemType="ess" isMasterControl={true} />}
      {selectedSwt === 'tgs' && <SystemMain systemType="tgs" isMasterControl={true} />}
      {selectedSwt === 'tes' && <SystemMain systemType="tes" isMasterControl={true} />}
    </Wrapper>
  );
};
